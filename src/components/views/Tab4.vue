  ...
  <div>
    <v-card-title>
      ...
      <v-card-text>
       ...
       Door te klikken op de punten/symbolen ? op de kaart verschijnt een grafiek van het berekende grondwaterverloop op deze locatie: een tijdreeks van de grondwaterstand tot nu toe, en tijdreeksen van het toekomstige verloop van de grondwaterstand voor de drie scenario’s.
       In de grafiek wordt ook informatie gegeven over de historische grondwaterstanden in het gebied / op deze locatie.
      </v-card-text>
...
import { tab4, items_tab3 } from "../../config/datalayers-config.js";
